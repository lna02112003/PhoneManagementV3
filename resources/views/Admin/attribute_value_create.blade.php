                ...
                <div class="col span_2">
                    <form method="POST" action="{{ route('attribute_value.store') }}">        
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="price_in" id="price_in" class="form-control" placeholder="Price In">
                        </div>

                        <div class="form-group">
                            <label for="price_out">Price Out:</label>
                            <input type="text" name="price_out" id="price_out" class="form-control" placeholder="Price Out">
                        </div>
